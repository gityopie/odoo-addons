odoo.define('web_google_maps.MapRenderer', function (require) {
    ...
    var GoogleMapSidebar = Widget.extend({
        template: 'MapView.SidebarContent',
        init: function (parent, options) {
            this._super.apply(this, arguments);
            this.parent = parent;
            this.data = parent.state.data;
            console.log(this);
        }
    });
    ...
    var MapRenderer = BasicRenderer.extend({
        ...
        _initMap: function () {
            ...
            this.$right_sidebar = this.$('.o_map_sidebar_container');
        ...
        _renderSidebarGroup: function () {
            var sidebar = new GoogleMapSidebar(this, {'groups': []});
            this.$right_sidebar.append(sidebar);
            sidebar.appendTo(this.$right_sidebar.find('.o_map_right_sidebar'));
            // if (this.markerGroupedInfo.length > 0) {
            //     this.$right_sidebar.empty().removeClass('closed').addClass('open');
            //     var groupInfo = new GoogleMapSidebar(this, {
